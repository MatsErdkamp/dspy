...
class DspyGEPAResult:
    ...
    val_aggregate_subscores: Optional[List[Dict[str, float]]]
...
class GEPA(Teleprompter):
    ...
    def __init__(
        ...
        *,
        ...
        pareto_frontier_type: Literal["instance", "objective", "hybrid"] = "instance",
        ...
        def feedback_fn_creator(pred_name: str, predictor) -> "PredictorFeedbackFn":
            def feedback_fn(
                ...
                if isinstance(o, ScoreWithFeedback):
                    ...
                    score = o["score"]
                    feedback = (
                        o.get("feedback") or f"This trajectory got a score of {score}."
                    )
                    subscores = o.get("subscores", {})
                    return ScoreWithFeedback(
                        score=score, subscores=subscores, feedback=feedback
                    )
                else:
                    score = float(o)
                    return ScoreWithFeedback(
